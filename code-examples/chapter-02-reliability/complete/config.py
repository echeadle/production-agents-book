"""
Agent configuration management with timeout support.
...
class AgentConfig:
    ...
    llm_timeout: float = 30.0  # Max 30 seconds for LLM API calls
    tool_timeout: float = 10.0  # Max 10 seconds for tool executions
    ...
    def from_env(cls) -> "AgentConfig":
        ...
        return cls(
            ...
            tool_timeout=float(os.getenv("TOOL_TIMEOUT", "10.0")),
            total_timeout=float(os.getenv("TOTAL_TIMEOUT", "120.0")),
        )
